# Public APIs — full catalog

Verbatim copy of the category index and tables from
[public-apis/public-apis](https://github.com/public-apis/public-apis)'s `README.md`,
commit [`988c57b`](https://github.com/public-apis/public-apis/commit/988c57be4616cc9507fd3e8c34adedba5387f079)
(2026-08-27), with the source repo's own promotional banner stripped. See
[`public-apis-reference.md`](./public-apis-reference.md) for how this is meant to be used
in this project, and a shortlist of picks relevant to this dashboard.

Licensed by the source repo under the MIT License — see their
